...
cd /var/www/html
wget https://worldofdragon.net/painel/multipanel/panel_v25/PAINEL-V.25.zip > /dev/null 2>&1
...
sleep 1
cd
wget https://worldofdragon.net/painel/multipanel/panel_v25/BD-Painel-v23.sql > /dev/null 2>&1
sleep 1
